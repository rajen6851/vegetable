                                    ...
                                    <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                        <div class="col">
                                            <div class="slider__content slider__content--padding__left">
                                                <span class="slider__content--subtitle text__secondary">Eat clean and green</span>
                                                <h2 class="slider__content--maintitle h1">Natural is <span class="text__secondary">always</span> <br>
                                                    Healthy</h2>
                                                <p class="slider__content--desc">The more you love your health, more you eat organic. No medicine can heal you better than organic food does</p>    
                                                <a class="btn slider__btn" href="shop.html">Shop Now</a>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="hero__slider--layer">
                                                <img class="slider__layer--img "  width="755" height="481" src="{{asset('public/assets/img/slider/home1-slider1-layer.jpg')}}" alt="slider-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="hero__slider--layer home1__slider--layer2">
                                                <img class="slider__layer--img  home1__slider--layer2__img" src="assets/img/slider/home1-slider2-layer.png" alt="slider-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- End categories product section -->
                                    ...
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="{{ route('productdetails', $product->id) }}">
                                                 <img class="product__items--img product__primary--img" src="{{ asset('public/assets/images/Product/' . $product->image) }}" alt="">
                                            ...
                                            <ul class="product__items--action">
                                                ...
                                                <form action="{{ Route('savewishlist') }}" method="post">
                                                    @csrf
                                                    @if (Auth::check())
                                                        <?php $userId = Auth::id(); ?>
                                                        <input type="hidden" id="user_id_cart" value="{{ $userId }}" name="user_id">
                                                    @endif
                                                    <input type="hidden" name="product_id" value="{{ $product->id }}">
                                                    <input type="hidden" name="price" value="{{ $product->price }}">
                                                    @if (Auth::check())
                                                         <button type="submit" class="product__items--action__btn" title="Add to Wishlist">
        ...
        <span class="visually-hidden">Wishlist</span>
                                                    ...
                                                    @else
                                                        {{-- <a href="{{ route('login') }}" class="action wishlist" title="Wishlist"><i class="pe-7s-like"></i></a> --}}
                                                        <a href="{{ route('login') }}" 
   ...
   title="Add to Wishlist">
    ...
    <!-- Product Unit -->
    <p class="product__items--unit">
        {{ $product->unit }}
    </p>

        <!-- Product Unit -->
    <p class="product__items--description">
        {{ $product->description }}
    </p>
...
<style>
    ...
    margin: 8px 0; /* Name aur title ke beech gap */
}

.product__items--unit {
    font-size: 14px;
    color: #555;
    margin-bottom: 6px; /* unit aur price ke beech gap */
    display: block;
}

.product__items--description {
    font-size: 14px;
    color: #852525;
    margin-bottom: 6px; /* unit aur price ke beech gap */
    display: block;
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product__items">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title style2 h4"><a href="product-details.html">Raw-onions-surface</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$58.00</span>
                                        <span class="old__price">$68.00</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title style2 h4"><a href="product-details.html">Papaya-green</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$48.00</span>
                                        <span class="old__price">$54.00</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title style2 h4"><a href="product-details.html">Vegetable-healthy</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$39.00</span>
                                        <span class="old__price">$59.00</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title style2 h4"><a href="product-details.html">Fresh-whole-fish</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$38.00</span>
                                        <span class="old__price">$44.00</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items">
                                ...
                                <div class="product__items--content text-center">
                                    <a class="add__to--cart__btn" href="cart.html">+ Add to cart</a>
                                    <h3 class="product__items--content__title style2 h4"><a href="product-details.html">Green-surface</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$38.00</span>
                                        <span class="old__price">$40.00</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items d-flex align-items-center">
                                ...
                                <div class="testimonial__items--content">
                                    ...
                                    <p class="testimonial__items--desc">Lorem ipsum dolor sit, amet consectetur is adipisicing elit. Recusandae iusto veritatis eveniet, amet sint are suscipit!</p>
