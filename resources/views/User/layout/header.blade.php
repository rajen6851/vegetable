            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="{{Route('user_home')}}"><img width="60px" height="66px" class="main__logo--img" src="{{asset('public/assets/img/logo/nav-log3.png')}}" alt="logo-img"></a></h1>
                    </div>
