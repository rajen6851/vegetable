...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('public/assets/images/favicon/favicon.ico')}}" type="image/png">
...
<link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" />
    ...
    <!-- <link rel="stylesheet" href="{{asset('public/assets/css/vendor/bootstrap.bundle.min.css')}}" />
    <link rel="stylesheet" href="{{asset('public/assets/css/vendor/pe-icon-7-stroke.css')}}" />
    <link rel="stylesheet" href="{{asset('public/assets/css/vendor/font.awesome.css')}}" /> -->
    ...
    <link rel="stylesheet" href="{{asset('public/assets/css/plugins/venobox.css')}}" /> -->
