  ...
  <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px">
            <path d="..."></path>
                                                        ...
                                                        <div class="cart__thumbnail">
                                                            <a href="{{ url('/productdetail/' . $cart->product_id) }}"><img class="border-radius-5" src="{{asset('build/assets/images/Product/' . $cart->product_img)}}" alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h3 class="cart__content--title h4"><a href="product-details.html">{{$cart->product_name}}</a></h3>
                                                            <span class="cart__content--variant">WEIGHT: {{$cart->product_weight}}</span>
                                                            <span class="cart__content--variant">Detail: {{$cart->product_desc}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="cart__table--body__list">
                                                ...
                                                <td class="cart__table--body__list">
                                                    ...
                                                    @endphp
                                                    <span class="cart__price end">₹{{$totalvalue}}</span>
                                                </td>
                                            </tr>
                                             @endforeach
                                        </tbody>
