                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product1.jpg"><img class="product__media--preview__items--img" src="{{ asset('public/assets/images/Product/' . $productdetails->image) }}" alt="product-media-img"></a>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('public/assets/images/Product/' . $productdetails->image) }}" alt="product-nav-img">
                                        </div>
                                    </div>
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            ...
                            <form action="{{Route('savecart')}}" method="POST">
                                @csrf
                                <input name="price" type="hidden" value="{{$productdetails->price}}">
                                ...
                                <div class="product__details--info__price mb-15">
                                    ...
                                    <span class="old__price">${{$productdetails->price}}</span>
                                </div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <ul class="variant__size d-flex">
                                                <li class="variant__size--list">
                                                    ...
                                                    <label class="variant__size--value red" for="weight1">{{$productdetails->unit}}</label>
                                                </li>
                                            </ul>
                                        </fieldset>
                                    </div>
                                ...
                                {{-- <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img" src="{{asset('public/assets/img/other/safe-checkout.png')}}" alt="Payment Image">
                                </div> --}}
                            </form>
                        </div>
                    </div>
