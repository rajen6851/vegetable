                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                               ...
                                               <i class="mdi mdi-plus me-1"></i>Add New Product
                                                ...
                                                <a href="{{ route('product.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2">Add New Product</a>
                                 ...
                                 @foreach($products as $product)
                                    <tr>
                                       ...
                                       <td>
                                           ...
                                           <img src="{{ asset('build/assets/images/Product/' . $product->image) }}" alt="" class="avatar-md p-1">
                                        ...
                                        <td>
                                           <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end" style="">
                                                                    <li><a href="{{url('admin/Category/edit',$product->id)}}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                                    <li><a href="{{url('admin/Category/delete',$product->id)}}" class="dropdown-item"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>
                                                                </ul>
                                                            </div>
